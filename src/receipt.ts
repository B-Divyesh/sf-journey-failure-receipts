...
<footer><p class="privacy">Local receipt · no request/response bodies · URL paths and query strings discarded</p><p>Generated by Journey Failure Receipts 0.1.2.</p></footer>
</main></body></html>`;
}

...
- `site/public/share-card.svg` and `site/public/apple-touch-icon.svg` are hand-drawn project assets made on 2026-08-28. They reuse the warm paper, cyan construction rules, navy route, and vermilion failed-node mark from the hero art; no third-party artwork is used.
